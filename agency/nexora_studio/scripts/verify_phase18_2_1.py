...
def run_verification():
    ...
    with registry.cursor() as cr:
        ...
        AdapterClass = env['nexora.ai_adapter.generic_openai'].__class__
        ...
        # Rollback all mock data to prevent test pollution
        env.cr.rollback()
        _logger.info("Mock data rolled back successfully.")
        ...
        report_path = os.path.join(reports_dir, "phase18_2_1_validation_report.md")
        
        with open(report_path, "w", encoding="utf-8") as f:
            f.write("# Phase 18.2.1 Validation Report\n\n")
