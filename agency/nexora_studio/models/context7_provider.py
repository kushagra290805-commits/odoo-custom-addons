...
class Context7Provider(models.AbstractModel):
    ...
    def execute(self, request: ProviderExecutionRequest) -> ProviderExecutionResult:
        ...
        """
        Canonical execution interface for Context7.
        ...
        try:
            ...
            _logger.error(f"Context7 MCP execution error: {e}")
            return ProviderExecutionResult(success=False, data=None, error=f"Context7 MCP error: {str(e)}", execution_ms=(time.time()-start_time)*1000)
